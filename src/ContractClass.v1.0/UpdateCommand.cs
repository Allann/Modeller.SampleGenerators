...
namespace ContractClass
{
    public class UpdateCommand : IGenerator
    {
        ...
        public IOutput Create()
        {
            ...
            sb.al("{");
            sb.i(1).al($"public class {_model.Name}UpdateCommand : IRequest<UpdatedResponse>");
            sb.i(1).al("{");
            ...
            return new File(_model.Name + "UpdateCommand.cs", sb.ToString(), path: $"v1\\Commands\\{_model.Name.Plural.Value}");
        }
    }
}