...
namespace ContractClass
{
    public class ByIdQuery : IGenerator
    {
        ...
        public IOutput Create()
        {
            ...
            sb.al("{");
            sb.i(1).a($"public class {_model.Name}ByIdQuery : IRequest<{_model.Name}Response>");
            sb.i(1).al("{");
            sb.i(2).a($"public class {_model.Name}ByIdQuery(string businessKey)");
            sb.i(2).al("{");
            ...
            return new File { Name = _model.Name + "ByIdQuery.cs", Path = $"Queries/{_model.Name.Plural.Value}", Content = sb.ToString() };
        }
    }
}