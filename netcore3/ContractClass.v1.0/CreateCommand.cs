...
namespace ContractClass
{
    public class CreateCommand : IGenerator
    {
        ...
        public IOutput Create()
        {
            ...
            sb.al("{");
            sb.i(1).a($"public class {_model.Name}CreateCommand : IRequest<CreatedResponse>");
            sb.i(1).al("{");
            ...
            return new File { Name = _model.Name + "CreateCommand.cs", Path = $"Commands/{_model.Name.Plural.Value}", Content = sb.ToString() };
        }
    }
}